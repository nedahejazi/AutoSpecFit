...
def parameter_change_is_converged(
    ...
    return (
        ...
        and d_alpha <= (config.alpha_convergence_tolerance + comparison_epsilon)
...
def update_convergence_history_table(
    ...
    n_above_active = int(
        np.sum(
            ...
            & (abundance_changes > active_tolerance + comparison_epsilon)
        )
    )
    n_above_010 = int(
        np.sum(
    ...
    block = [
        ...
        f"N_Elements_Above_Active_Tolerance: {n_above_active}",
